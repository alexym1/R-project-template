# Contributing to cookr

This outlines how to propose a change to cookr.
...
Report bugs at <https://github.com/alexym1/cookr/issues>.
...
* 1. Clone the repo
    ...
    ```
    git clone git@github.com:alexym1/cookr.git
    ```
